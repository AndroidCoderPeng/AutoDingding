...
# 最新版本 2.0.0 —— 更新时间：2024年12月31日09点40分
...
#### [DT_20241230_2.0.0.apk，适合Android 8+系统](apk/daily/release/DT_20241230_2.0.0.apk)
...
5. 添加任务导出/导入功能。导出功能在“任务配置”里，导入功能在主界面“+”那里，只支持无任务的时候导入。
6. 邮箱配置改为用户自定义。
7. 各种细节优化。
