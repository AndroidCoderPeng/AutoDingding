...
# 说几句（最新版本 1.5.5）- 更新时间：2024年10月28日14点19分
...
#### [AUTO_20241028_1.5.5.apk，适合Android 6+系统](apk/auto/release/AUTO_20241028_1.5.5.apk)

1. 添加支付宝消息打卡响应，修改多条微信消息不响应打卡消息的问题
2. 添加常驻通知栏和锁屏通知显示应用运行状态。注意：锁屏通知需要在手机设置功能里面找到通知管理，然后将本应用锁屏通知显示设置为显示通知及其内容，不设置也可，只是锁屏后不显示应用状态
