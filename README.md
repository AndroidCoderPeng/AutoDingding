...
# 说几句（最新版本 1.5.8）- 更新时间：2024年12月2日10点34分
...
#### [AUTO_20241202_1.5.8.apk，适合Android 6+系统](apk/auto/release/AUTO_20241202_1.5.8.apk)

1. 主界面添加音量减少按键监听，添加伪装灭屏状态界面（通过[音量-]()触发）
