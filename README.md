...
# 说几句（最新版本 1.4.8）- 更新时间：2024年7月17日 08点30分
...
#### [被检测到作弊的，用此版本（Android 6+）(AUTO_20240717_1.4.8.apk)](apk/auto/release/AUTO_20240717_1.4.8.apk)

1. 经过多人多天测试，最终发现目前检测机制是：应用打开了无障碍服务。所以，最新版本完全删除无障碍服务。
2. 如果使用的带有无障碍物服务版本的同学，请在应用内关闭此选项，或者使用最新版
