...
# 说几句（最新版本 1.4.7）- 更新时间：2024年7月12日16点34分 (未测试，稳定性未知，慎用) 
...
#### [被检测到作弊的，用此版本（Android 6+）(AUTO_20240712_1.4.7.apk)](apk/auto/release/AUTO_20240712_1.4.7.apk)

1. 新增Q&A界面，方便用户使用
2. 考虑到有不少用户钉钉打卡结果被管理关了，所以，添加自动截屏功能，添加发送打卡结果附件邮件功能（一定要开无障碍服务，否则无法截屏！）
