...
# 说几句（最新版本 1.5.3）- 更新时间：2024年10月12日09:56:29
...
#### [AUTO_20241012_1.5.3.apk，适合Android 6+系统](apk/auto/release/AUTO_20241012_1.5.3.apk)
...
| 序号  | 原因                                      |
|:----|:----------------------------------------|
| 1   | 手机开启了无障碍服务或者有别的应用用到了无障碍服务，比如：李跳跳之类的辅助软件 |
| 2   | 使用了模拟定位软件试图修改打卡位置                       |
| 3   | 使用了向日葵等远程远程控制软件打开                       |
| 4   | 手机数据线连着电脑且手机开着开发者模式的USB调试功能             |
| 5   | 试图使用adb命定模拟手指点击打卡                       |
